...
test_that("scale_colour_thekids() defaults to the primary palette", {
  expected_pal <- thekids_pal("primary", discrete=TRUE, reverse=FALSE)
  expected_cols <- expected_pal(3)

  scale <- scale_colour_thekids()
  actual_cols <- scale$palette(3)

  expect_equal(actual_cols, expected_cols)
})


test_that("returns correct scale when discrete is TRUE or FALSE in scale_colour_thekids()", {
...
test_that("discrete scale works in ggplot for scale_colour_thekids()", {
...
test_that("continuous scale works in ggplot for scale_colour_thekids()", {
...
test_that("palette is applied correctly for discrete scale in scale_colour_thekids()", {
...
test_that("invalid palette throws error in scale_colour_thekids()", {
  expect_error(
...
test_that("sequential palette names give the correct palette in scale_colour_thekids()", {
...
test_that("diverging palette names give the correct palette in scale_colour_thekids()", {
...
test_that("scale_fill_thekids() defaults to the primary palette", {
  expected_pal <- thekids_pal("primary", discrete=TRUE, reverse=FALSE)
  expected_cols <- expected_pal(3)

  scale <- scale_fill_thekids()
  actual_cols <- scale$palette(3)
...
test_that("returns correct scale when discrete is TRUE or FALSE in scale_fill_thekids()", {
...
test_that("discrete scale works in ggplot for scale_fill_thekids()", {
...
test_that("continuous scale works in ggplot for scale_fill_thekids()", {
...
test_that("palette is applied correctly for discrete scale in scale_fill_thekids()", {
  pal <- thekids_pal("primary", TRUE, FALSE)
  expected <- pal(3)
...
test_that("invalid palette throws error in scale_fill_thekids()", {
  expect_error(
...
test_that("sequential palette names give the correct palette in scale_fill_thekids()", {
...
test_that("diverging palette names give the correct palette in scale_fill_thekids()", {
